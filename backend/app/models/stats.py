...
class UserGameStats(Base):
    ...
    winks_used: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
    knocks_used: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
    ...
    top_voter_against_me_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    top_voter_against_me_count: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
    top_vote_target_by_me_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
    top_vote_target_by_me_count: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
    votes_against_me_map: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict, server_default="{}")
    votes_by_me_map: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict, server_default="{}")
    recent_games: Mapped[list] = mapped_column(JSONB, nullable=False, default=list, server_default="[]")
