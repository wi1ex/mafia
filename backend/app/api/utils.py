...
def build_app_settings_snapshot_defaults(core_settings_obj: Any, *, default_starts: Sequence[int], snapshot_cls: Any) -> Any:
    ...
    return snapshot_cls(
        ...
        support_service_1_enabled=getattr(core_settings_obj, "SUPPORT_SERVICE_1_ENABLED", True),
        support_service_2_enabled=getattr(core_settings_obj, "SUPPORT_SERVICE_2_ENABLED", True),
...
def build_app_settings_snapshot_from_row(row: Any, *, default_starts: Sequence[int], snapshot_cls: Any) -> Any:
    ...
    return snapshot_cls(
        ...
        support_service_1_enabled=bool(getattr(row, "support_service_1_enabled", True)),
        support_service_2_enabled=bool(getattr(row, "support_service_2_enabled", True)),
...
def public_settings_out(settings) -> "PublicSettingsOut":
    ...
    return PublicSettingsOut(
        ...
        support_service_1_enabled=bool(getattr(settings, "support_service_1_enabled", True)),
        support_service_2_enabled=bool(getattr(settings, "support_service_2_enabled", True)),
