          ...
          <div class="slide-surface">
            <div class="slide-content">
              ...
              <div class="info-banner">
                ...
                <p>Кастомизация профиля (GIF-аватары, выбор цвета и иконки профиля), обнуление истории никнеймов, скрытые комнаты без зрителей и трансляции в качестве 1080p.</p>
              </div>
