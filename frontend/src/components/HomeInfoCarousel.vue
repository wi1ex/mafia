          ...
          <div class="slide-surface">
            <div class="slide-content">
              ...
              <div class="info-banner">
                ...
                <p>Кастомизация профиля (GIF-аватары, выбор цвета и иконки профиля), скрытые комнаты без зрителей, трансляции в качестве 1080p и история никнеймов пользователей.</p>
              </div>
