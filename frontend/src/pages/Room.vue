    ...
    <template v-else>
      ...
      <div v-if="!isTheater" class="grid" :style="gridStyle">
        <RoomTile
          ...
          :finish-points="gameFinished ? game.gamePointsForUser(id) : null"
...
import RoomTile from '@/views/RoomTile.vue'
import RoomRequests from '@/views/RoomRequests.vue'
import RoomSetting from '@/views/RoomSetting.vue'
import GameParams from '@/views/GameParams.vue'
import GameVersions from '@/views/GameVersions.vue'
