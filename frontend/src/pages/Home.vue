      ...
      <div class="right-extra right-extra--primary">
        ...
        <div class="right-extra-tooltip">
          <UiTooltip
            ...
            кастомизация профиля (GIF-аватары, выбор цвета и иконки профиля), обнуление истории никнеймов,
            скрытые комнаты, игры без зрителей и трансляции в высоком качестве."
            placement="top-left"
          />
        </div>
