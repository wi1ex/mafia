        ...
        <section class="rules-grid">
          <article id="section-1" class="rule-card">
            ...
            <ul>
              ...
              <li>1.3. Для регистрации и авторизации пользователь использует логин и пароль, созданные при регистрации.</li>
              <li>1.4. Для доступа к комнатам требуется верификация через Telegram-бота. Верификация подтверждает привязку Telegram-аккаунта к аккаунту на платформе.</li>
