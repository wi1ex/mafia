      ...
      <div class="rules-content">
        <section id="intro" class="hero">
          <div class="hero-content">
            ...
            <div class="tags">
              ...
              <span class="pill">Редакция от 24.03.2026</span>
            </div>
          </div>
        </section>
        ...
        <section class="rules-grid">
          ...
          <article id="mafia-rules" class="rule-card">
            ...
            <ul>
              <li>8.1. Переписка с игроками стола или третьими лицами по игре и другие неигровые способы получения информации.</li>
              <li>8.2. Преднамеренное «вскрытие роли» другим игрокам любыми способами.</li>
              <li>8.3. Влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, фото/видео, скрины, откаты и т.п.</li>
              <li>8.4. Использование клятвы и/или пари в любой форме, а также их аналогов с целью доказывания своей роли и/или влияния на ход игры.</li>
              <li>8.5. Использование шантажа, угроз и/или подкупа с целью влияния на ход игры.</li>
              <li>8.6. Доказывание игроком, «вскрывшимся» шерифом, своей роли с помощью уникальной «ночной» информации.</li>
              <li>8.7. Апеллирование к неигровым этическим и/или религиозным ценностям или иные «неигровые апелляции» с целью доказывания своей роли или влияния на исход голосования.</li>
              <li>8.8. Озвучивать речевую информацию на языке, который очевидно скрывает смысл от ведущего/судьи или большинства игроков.</li>
              <li>8.9. Оскорблять других игроков или ведущего, использование мата и нецензурной лексики, неэтичное поведение и споры с ведущим.</li>
              <li>8.10. Жестикуляция и призывы во время фазы голосования, мольба и слёзы.</li>
              <li>8.11. Вскрытие шерифом с проверкой без отката, будучи красным, которое привело к поражению красных.</li>
              <li>8.12. Намеренно покидать/«руинить» игру, независимо от роли, если это ломает/портит ход игры.</li>
              <li>8.13. Апеллирование к своему/чужому цвету исходя из игрового стиля игрока или личных взаимоотношений с ним.</li>
              <li>8.14. Ведущему запрещено злоупотреблять правами, требовать оплату за проведение игр (если владелец комнаты это запрещает), применять меры и совершать действия из личной выгоды.</li>
              <li>8.15. Ведущему запрещено раскрывать роли до окончания игры или подсказывать/комментировать так, что это внесет игровую информацию.</li>
              <li>8.16. После решающего убийства/голосования, определившего результат игры, меры, связанные с игровым преимуществом, как правило, не применяются, если нарушение уже не могло повлиять на исход (кроме грубых нарушений поведения/безопасности, которые могут наказываться всегда).</li>
            </ul>
          </article>
        </section>
      </div>
