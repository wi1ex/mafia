      ...
      <div class="rules-content">
        ...
        <section class="rules-grid">
          ...
          <article id="section-7" class="rule-card">
            ...
            <ul>
              <li>7.1. В игровых комнатах нарушения в рамках игры фиксирует ведущий/судья. Подать жалобу могут как игроки, так и свидетели нарушения. Срок давности для нарушений и подачи жалоб - 7 дней.</li>
              ...
              <li>7.5. Апелляции: пользователь вправе подать апелляцию в течение 3 дней, приложив аргументы и доказательства. Повторные апелляции по тем же фактам могут быть отклонены.</li>
            </ul>
          </article>
          ...
          <article id="mafia-rules" class="rule-card">
            ...
            <ul>
              ...
              <li>8.8. Ведущему запрещено злоупотреблять правами, требовать оплату за проведение игр (если владелец комнаты это запрещает), применять меры и совершать действия из личной выгоды.</li>
              <li>8.9. Ведущему запрещено раскрывать роли до окончания игры или подсказывать/комментировать так, что это внесет игровую информацию.</li>
