        ...
        <section class="rules-grid">
          <article id="section-1" class="rule-card">
            ...
            <ul>
              ...
              <li>1.3. Для авторизации/регистрации пользователь использует Telegram. Авторизация возможна только при передаче платформе данных Telegram, необходимых для идентификации и работы аккаунта.</li>
              <li>1.4. При регистрации пользователь соглашается на обработку данных, получаемых от Telegram и/или предоставляемых пользователем, включая: Telegram-ID, никнейм/аватар (если имеется).</li>
              <li>1.5. Пользователь может отозвать согласие на обработку данных, удалив свой аккаунт в Личном кабинете.</li>
              <li>1.6. Аккаунт на платформе привязан к Telegram-ID пользователя. При применении санкций доступ к платформе может быть ограничен/заблокирован именно для аккаунта, авторизованного через соответствующий Telegram-аккаунт.</li>
            </ul>
          </article>
