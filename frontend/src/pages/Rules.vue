...
const SCORING_SECTIONS: ScoringSection[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      rule('vote_sheriff_nine_red', 'Штраф за вывод шерифа в 9ке', 'Со второго дня: красному, голосовавшему в настоящего шерифа, который фактически ушёл единолично по голосованию, если на момент подведения итогов результирующего голосования было ровно девять живых. Переголосование учитывается, общий подъём — нет. Не голосовавшие в шерифа штраф не получают.'),
      rule('vote_sheriff_nine_black', 'Бонус за вывод шерифа в 9ке', 'При тех же условиях девятки и единоличного ухода шерифа со второго дня: каждому чёрному, голосовавшему в него. Это дополнительный бонус, который складывается с обычными баллами за голос в противоположную команду, а не заменяет их. Применяется общий лимит суммы допбаллов.'),
