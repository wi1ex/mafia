      ...
      <div class="rules-content">
        ...
        <section class="rules-grid">
          ...
          <article id="section-7" class="rule-card">
            ...
            <ul>
              <li>7.1. В игровых комнатах нарушения в рамках игры фиксирует ведущий/судья. Подать жалобу могут как игроки, так и свидетели нарушения. Срок давности для нарушений и подачи жалоб - 3 дня.</li>
              ...
              <li>7.3. Допустимые доказательства: записи экрана и скриншоты, информация из первых уст (свидетелей нарушения), системные события.</li>
              ...
              <li>7.5. Апелляции: пользователь вправе подать апелляцию в течение 1 дня, приложив аргументы и доказательства. Повторные апелляции по тем же фактам могут быть отклонены.</li>
            </ul>
          </article>
