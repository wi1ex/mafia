        ...
        <section class="rules-grid">
          ...
          <article id="section-4" class="rule-card">
            ...
            <ul>
              ...
              <li>4.3.5. Запрещено загружать, публиковать или распространять через общий чат, личные сообщения, фото, видео, стикеры и иные вложения материалы, нарушающие настоящие Правила.</li>
            </ul>
          ...
          <article id="mafia-rules" class="rule-card">
            ...
            <ul>
              ...
              <li>8.3. Запрещено влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, стикеры, фото/видео, скрины, откаты и т.п.</li>
