      ...
      <div class="rules-content">
        ...
        <section id="sanctions" class="notice">
          <div class="notice-text">
            ...
            <p>Конкретный вид санкции, срок и дополнительные меры определяются Администрацией или уполномоченными модераторами с учётом характера нарушения, повторяемости, последствий и иных обстоятельств.</p>
          </div>
        ...
        <section class="rules-grid">
          ...
          <article id="section-2" class="rule-card">
            ...
            <ul>
              ...
              <li>2.2. Пользователь подтверждает, что осознаёт риски публичного общения и обязуется соблюдать ограничения по контенту (включая 18+).</li>
          ...
          <article id="section-4" class="rule-card">
            ...
            <ul>
              ...
              <li>4.3.3. Запрещена демонстрация/пропаганда/сбыт/инструкции по наркотикам и запрещённым веществам.</li>
          ...
          <article id="section-6" class="rule-card">
            ...
            <ul>
              ...
              <li>6.5. Запрещена реклама, публикация ссылок на платёжные страницы, сбор средств без согласования с администрацией.</li>
            </ul>
          </article>
          ...
          <article id="section-7" class="rule-card">
            ...
            <ul>
              ...
              <li>7.2. Жалобы по оскорблениям/личным конфликтам могут приниматься от пострадавшей стороны, нарушения приватности/мошенничества/безопасности/запрещённого контента рассматриваются по обращению любого пользователя или по инициативе Администрации/модерации.</li>
          ...
          <article id="mafia-rules" class="rule-card">
            ...
            <ul>
              ...
              <li>8.5. Оскорблять других игроков или ведущего, использование мата и нецензурной лексики, неэтичное поведение и споры с ведущим, агрессивное поведение/крики или мольба/слёзы.</li>
