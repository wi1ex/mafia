      ...
      <div class="rules-content">
        <section id="intro" class="hero">
          <div class="hero-content">
            ...
            <div class="tags">
              ...
              <span class="pill">Редакция от 21.03.2026</span>
            </div>
          </div>
        </section>
        ...
        <section class="rules-grid">
          ...
          <article id="mafia-rules" class="rule-card">
            ...
            <ul>
              <li>8.1. Переписка с третьими лицами по игре и другие неигровые способы получения информации.</li>
              ...
              <li>8.12. Ведущему запрещено злоупотреблять правами, требовать оплату за проведение игр (если владелец комнаты это запрещает), применять меры и совершать действия из личной выгоды.</li>
              <li>8.13. Ведущему запрещено раскрывать роли до окончания игры или подсказывать/комментировать так, что это внесет игровую информацию.</li>
              <li>8.14. После решающего убийства/голосования, определившего результат игры, меры, связанные с игровым преимуществом, как правило, не применяются, если нарушение уже не могло повлиять на исход (кроме грубых нарушений поведения/безопасности, которые могут наказываться всегда).</li>
            </ul>
          </article>
        </section>
      </div>
