...
const sanctionReasons = [
  ...
  { value: '1.3. Для регистрации и авторизации пользователь использует логин/никнейм и пароль, созданные при регистрации.', label: '1.3. Для регистрации и авторизации пользователь использует логин/никнейм и пароль, созданные при регистрации.' },
