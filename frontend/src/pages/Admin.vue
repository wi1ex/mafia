...
const sanctionReasons = [
  ...
  { value: '4.3.5. Запрещено загружать, публиковать или распространять через общий чат, личные сообщения, фото, видео, стикеры и иные вложения материалы, нарушающие настоящие Правила.', label: '4.3.5. Запрещено загружать, публиковать или распространять через общий чат, личные сообщения, фото, видео, стикеры и иные вложения материалы, нарушающие настоящие Правила.' },
