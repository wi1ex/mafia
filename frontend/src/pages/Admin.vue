...
const sanctionReasons = [
  ...
  { value: '1.3. Для регистрации и авторизации пользователь использует логин и пароль, созданные при регистрации.', label: '1.3. Для регистрации и авторизации пользователь использует логин и пароль, созданные при регистрации.' },
  { value: '1.4. Для доступа к комнатам требуется верификация через Telegram-бота. Верификация подтверждает привязку Telegram-аккаунта к аккаунту на платформе.', label: '1.4. Для доступа к комнатам требуется верификация через Telegram-бота. Верификация подтверждает привязку Telegram-аккаунта к аккаунту на платформе.' },
