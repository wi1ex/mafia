...
const sanctionReasons = [
  ...
  { value: '2.2. Если на платформе доступны видео/аудио-трансляции, общий чат, обмен сообщениями, загрузка фото/видео, реакции и стикеры, пользователь подтверждает, что осознаёт риски публичного общения и обязуется соблюдать ограничения по контенту (включая 18+).', label: '2.2. Если на платформе доступны видео/аудио-трансляции, общий чат, обмен сообщениями, загрузка фото/видео, реакции и стикеры, пользователь подтверждает, что осознаёт риски публичного общения и обязуется соблюдать ограничения по контенту (включая 18+).' },
  ...
  { value: '4.1.1. Запрещены оскорбления, унижение, травля, клевета, жесткий троллинг, провокации, шантаж, угрозы, подстрекательство в любой форме, включая сообщения общего/личного чата, реакции, стикеры, подписи к фото/видео и иные пользовательские материалы.', label: '4.1.1. Запрещены оскорбления, унижение, травля, клевета, жесткий троллинг, провокации, шантаж, угрозы, подстрекательство в любой форме, включая сообщения общего/личного чата, реакции, стикеры, подписи к фото/видео и иные пользовательские материалы.' },
  ...
  { value: '4.3.5. Запрещено загружать, публиковать или распространять через общий чат, личные сообщения, фото, видео, стикеры и иные вложения материалы, нарушающие настоящие Правила, а также использовать реакции/стикеры для обхода этих ограничений.', label: '4.3.5. Запрещено загружать, публиковать или распространять через общий чат, личные сообщения, фото, видео, стикеры и иные вложения материалы, нарушающие настоящие Правила, а также использовать реакции/стикеры для обхода этих ограничений.' },
  { value: '4.4.1. Запрещён спам, флуд, массовые однотипные сообщения, навязчивая реклама, а также засорение общего чата реакциями, стикерами, упоминаниями и повторяющимися фото/видео.', label: '4.4.1. Запрещён спам, флуд, массовые однотипные сообщения, навязчивая реклама, а также засорение общего чата реакциями, стикерами, упоминаниями и повторяющимися фото/видео.' },
  ...
  { value: '7.3. Допустимые доказательства: записи экрана, скриншоты, логи комнаты и чата, системные события.', label: '7.3. Допустимые доказательства: записи экрана, скриншоты, логи комнаты и чата, системные события.' },
  ...
  { value: '8.3. Запрещено влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, стикеры, фото/видео, скрины, откаты и т.п.', label: '8.3. Запрещено влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, стикеры, фото/видео, скрины, откаты и т.п.' },
  ...
  { value: '8.5. Запрещено озвучивать речевую информацию на языке, который очевидно скрывает смысл от ведущего/судьи или большинства игроков.', label: '8.5. Запрещено озвучивать речевую информацию на языке, который очевидно скрывает смысл от ведущего/судьи или большинства игроков.' },
  ...
  { value: '8.7. Ведущему запрещено злоупотреблять правами, требовать оплату за проведение игр (если владелец комнаты это запрещает), применять меры и совершать действия из личной выгоды.', label: '8.7. Ведущему запрещено злоупотреблять правами, требовать оплату за проведение игр (если владелец комнаты это запрещает), применять меры и совершать действия из личной выгоды.' },
  { value: '8.8. Ведущему запрещено раскрывать роли до окончания игры или подсказывать/комментировать так, что это внесет игровую информацию.', label: '8.8. Ведущему запрещено раскрывать роли до окончания игры или подсказывать/комментировать так, что это внесет игровую информацию.' },
]
