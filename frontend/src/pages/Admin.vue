...
const sanctionReasons = [
  ...
  { value: '1.3. Для авторизации/регистрации пользователь использует Telegram. Авторизация возможна только при передаче платформе данных Telegram, необходимых для идентификации и работы аккаунта.', label: '1.3. Для авторизации/регистрации пользователь использует Telegram. Авторизация возможна только при передаче платформе данных Telegram, необходимых для идентификации и работы аккаунта.' },
  { value: '1.4. При регистрации пользователь соглашается на обработку данных, получаемых от Telegram и/или предоставляемых пользователем, включая: Telegram-ID, никнейм/аватар (если имеется).', label: '1.4. При регистрации пользователь соглашается на обработку данных, получаемых от Telegram и/или предоставляемых пользователем, включая: Telegram-ID, никнейм/аватар (если имеется).' },
  ...
  { value: '1.6. Аккаунт на платформе привязан к Telegram-ID пользователя. При применении санкций доступ к платформе может быть ограничен/заблокирован именно для аккаунта, авторизованного через соответствующий Telegram-аккаунт.', label: '1.6. Аккаунт на платформе привязан к Telegram-ID пользователя. При применении санкций доступ к платформе может быть ограничен/заблокирован именно для аккаунта, авторизованного через соответствующий Telegram-аккаунт.' },
  ...
  { value: '2.2. Если на платформе возможны видео/аудио-трансляции, пользователь подтверждает, что осознаёт риски публичного общения и обязуется соблюдать ограничения по контенту (включая 18+).', label: '2.2. Если на платформе возможны видео/аудио-трансляции, пользователь подтверждает, что осознаёт риски публичного общения и обязуется соблюдать ограничения по контенту (включая 18+).' },
  ...
  { value: '4.1.1. Запрещены оскорбления, унижение, травля, клевета, жесткий троллинг, провокации, шантаж, угрозы, подстрекательство.', label: '4.1.1. Запрещены оскорбления, унижение, травля, клевета, жесткий троллинг, провокации, шантаж, угрозы, подстрекательство.' },
