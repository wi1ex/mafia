...
const sanctionReasons = [
  ...
  { value: '4.1.3. Запрещена дискриминация/разжигание ненависти по полу, гендеру, расе, национальности, языку, возрасту, инвалидности, религии, политическим взглядам.', label: '4.1.3. Запрещена дискриминация/разжигание ненависти по полу, гендеру, расе, национальности, языку, возрасту, инвалидности, религии, политическим взглядам.' },
