...
const MAFIA_RULES = [
  '8.1. Переписка с третьими лицами по игре и другие неигровые способы получения информации.',
  '8.2. Преднамеренное «вскрытие роли» другим игрокам любыми способами.',
  '8.3. Влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, фото/видео, скрины, откаты и т.п.',
  '8.4. Использование клятвы и/или пари в любой форме, а также их аналогов с целью доказывания своей роли и/или влияния на ход игры.',
  '8.5. Использование шантажа, угроз и/или подкупа с целью влияния на ход игры.',
  '8.6. Доказывание игроком, «вскрывшимся» шерифом, своей роли с помощью уникальной «ночной» информации.',
  '8.7. Апеллирование к неигровым этическим и/или религиозным ценностям или иные «неигровые апелляции» с целью доказывания своей роли или влияния на исход голосования.',
  '8.8. Озвучивать речевую информацию на языке, который очевидно скрывает смысл от ведущего/судьи или большинства игроков.',
  '8.9. Оскорблять других игроков или ведущего, использование мата и нецензурной лексики, неэтичное поведение и споры с ведущим.',
  '8.10. Жестикуляция и призывы во время фазы голосования, мольба и слёзы.',
  '8.11. Вскрытие шерифом с проверкой без отката, будучи красным, которое привело к поражению красных.',
  '8.12. Ведущему запрещено злоупотреблять правами, требовать оплату за проведение игр (если владелец комнаты это запрещает), применять меры и совершать действия из личной выгоды.',
  '8.13. Ведущему запрещено раскрывать роли до окончания игры или подсказывать/комментировать так, что это внесет игровую информацию.',
  '8.14. После решающего убийства/голосования, определившего результат игры, меры, связанные с игровым преимуществом, как правило, не применяются, если нарушение уже не могло повлиять на исход (кроме грубых нарушений поведения/безопасности, которые могут наказываться всегда).',
] as const
