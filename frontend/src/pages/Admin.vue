...
const sanctionReasons = [
  ...
  { value: '8.3. Запрещено влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, фото/видео, скрины, откаты и т.п.', label: '8.3. Запрещено влияние на игру через общий/личный чат, сообщения/статусы «со стороны», реакции, фото/видео, скрины, откаты и т.п.' },
