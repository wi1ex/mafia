  ...
  <section class="profile card">
    ...
    <div class="grid">
      ...
      <div class="block">
        ...
        <div class="hint">
          3–32 символа: латиница, цифры, <code>._-</code> (не начинается с <code>user</code>).
        </div>
      </div>
    </div>
  </section>
...
const validNick = computed(() => /^[A-Za-z0-9._-]{3,32}$/.test(nick.value) && !/^user/i.test(nick.value))
