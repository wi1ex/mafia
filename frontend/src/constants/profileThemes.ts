...
export const PROFILE_THEME_OPTIONS = [
  { key: 'violet', title: 'Фиолетовый', bg: 'rgba(80, 40, 200, 0.6)', hover: 'rgba(80, 40, 200, 0.75)' },
  { key: 'mulberry', title: 'Тутовый', bg: 'rgba(180, 40, 100, 0.6)', hover: 'rgba(180, 40, 100, 0.75)' },
  { key: 'garnet', title: 'Гранатовый', bg: 'rgba(140, 20, 20, 0.6)', hover: 'rgb(140, 20, 20, 0.75)' },
  { key: 'terracotta', title: 'Терракотовый', bg: 'rgba(180, 120, 40, 0.6)', hover: 'rgba(180, 120, 40, 0.75)' },
  { key: 'amber', title: 'Янтарный', bg: 'rgba(160, 160, 40, 0.6)', hover: 'rgb(160, 160, 40, 0.75)' },
  { key: 'olive', title: 'Оливковый', bg: 'rgba(100, 160, 40, 0.6)', hover: 'rgb(100, 160, 40, 0.75)' },
  { key: 'emerald', title: 'Изумрудный', bg: 'rgba(40, 140, 120, 0.6)', hover: 'rgb(40, 140, 120, 0.75)' },
  { key: 'lagoon', title: 'Лагунный', bg: 'rgba(40, 140, 160, 0.6)', hover: 'rgba(40, 140, 160, 0.75)' },
