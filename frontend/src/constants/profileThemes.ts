...
export const PROFILE_THEME_OPTIONS = [
  ...
  { key: 'garnet', title: 'Гранатовый', bg: 'rgba(160, 40, 60, 0.8)', hover: 'rgba(160, 40, 60, 1)', shadow: 'rgba(160, 40, 60, 0.4)' },
  { key: 'terracotta', title: 'Терракотовый', bg: 'rgba(180, 120, 40, 0.8)', hover: 'rgba(180, 120, 40, 1)', shadow: 'rgba(180, 120, 40, 0.4)' },
  { key: 'amber', title: 'Янтарный', bg: 'rgba(180, 180, 20, 0.8)', hover: 'rgba(180, 180, 20, 1)', shadow: 'rgba(180, 180, 20, 0.4)' },
  { key: 'olive', title: 'Оливковый', bg: 'rgba(120, 180, 20, 0.8)', hover: 'rgba(120, 180, 20, 1)', shadow: 'rgba(120, 180, 20, 0.4)' },
